#!/usr/bin/env python3
"""
Windows-specific database creation script with enhanced error handling
"""
...
def create_database_windows():
    """Create database with enhanced Windows compatibility."""
    
    print("🌾 Creating Farm Financial Database (Windows)")
    print("=" * 50)
...
def insert_sample_data_direct(cursor):
    ...
    try:
        # Add sample data to hdb_main_data
...
if __name__ == "__main__":
    success = create_database_windows()
    if success:
